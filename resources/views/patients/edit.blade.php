        ...
        {!! Form::open(['route' => ['patients.update', 'id' => $patient->id ], 'files' => true, 'method' => 'PUT']) !!}
            ...
            <div class="form-group mt-4">
                ...
                <div class="form-check form-check-inline offset-2">
                    {{ Form::radio('gender', '男性', $patient->gender === '男性' || old('gender') === '男性' ? true : false, ['class'=>'form-check-input', 'for' => 'inlineCheckbox1']) }}
                    {!! Form::label('gender', '男性' , ['class' => 'form-check-label']) !!}
                </div>
                <div class="form-check form-check-inline offset-2">
                    {{ Form::radio('gender', '女性', $patient->gender === '女性' || old('gender') === '女性' ? true : false, ['class'=>'form-check-input', 'for' => 'inlineCheckbox2']) }}
